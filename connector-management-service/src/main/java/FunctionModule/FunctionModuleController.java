...
public class FunctionModuleController extends EntityController<FunctionModule> {
    ...
    @PostMapping("/")
    Mono<FunctionModule> createFunctionModule(@RequestBody FunctionModule functionModule){
    ...
    @GetMapping("/")
    Flux<FunctionModule> getAllFunctionModules() {
    ...
    @PutMapping("/")
    Mono<FunctionModule> updateFunctionModule(@RequestBody FunctionModule functionModule){
        return super.dataService.save(functionModule);
    }
