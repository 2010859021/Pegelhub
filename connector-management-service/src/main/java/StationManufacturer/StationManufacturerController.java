...
public class StationManufacturerController extends EntityController<StationManufacturer> {
    ...
    @PostMapping("/")
    Mono<StationManufacturer> createStationManufacturer(@RequestBody StationManufacturer stationManufacturer){
    ...
    @GetMapping("/")
    Flux<StationManufacturer> getAllStationManufacturer() {
    ...
    @PutMapping("/")
    Mono<StationManufacturer> updateStationManufacturer(@RequestBody StationManufacturer stationManufacturer){
        return super.dataService.save(stationManufacturer);
    }
